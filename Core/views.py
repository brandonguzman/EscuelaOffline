...
class BaseJuego(TemplateView, Logueado):
	...
	def get_template_names(self):
		...
		elif( nombre_juego == 'Canastita' ):
			return 'Canastita/Drag and Drop.html'
		elif( nombre_juego == 'Burbujitas' ):
		...
		elif( nombre_juego == 'Carrito Math' ):
			return 'carrito/carro-math.html'
		elif( nombre_juego == 'Laberinto' ):
			return 'Laberinto/Laberinto.html'
